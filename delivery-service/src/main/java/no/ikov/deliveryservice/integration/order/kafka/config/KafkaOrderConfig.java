...
public class KafkaOrderConfig {
    ...
    public ConsumerFactory<String, OrderPaymentSucceededEvent> consumerFactory() {
        Map<String, Object> configs = Map.of(
                ...
                JsonDeserializer.VALUE_DEFAULT_TYPE, OrderPaymentSucceededEvent.class.getName(),
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderPaymentSucceededEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, OrderPaymentSucceededEvent> consumerFactory) {
        ConcurrentKafkaListenerContainerFactory<String, OrderPaymentSucceededEvent> factory =
